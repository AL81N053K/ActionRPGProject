...
onready var checkBox_off_normal = preload("res://Theme stuff/Textures/CheckButton_Off.png")
onready var checkBox_off_focus = preload("res://Theme stuff/Textures/CheckButton_Off_focus.png")
onready var checkBox_on_normal = preload("res://Theme stuff/Textures/CheckButton_On.png")
onready var checkBox_on_focus = preload("res://Theme stuff/Textures/CheckButton_On_focus.png")
